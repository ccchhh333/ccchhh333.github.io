...
window.onload = function initTriangles(){
	...
	let cnt = document.getElementById( "shuru" ).value;
	numTimesToSubdivide = parseInt(cnt);
...
function tessellaTriangle( a, b, c ){
    ...
    var c_new = vec3.create();
        ...
        vec3.rotateZ( a_new, a, zerovec3,0);
        vec3.rotateZ( b_new, b, zerovec3,0 );
        vec3.rotateZ( c_new, c, zerovec3,0 );
